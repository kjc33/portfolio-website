  ...
  const featuredWorks1 = [
    {
      ...
      projectDescription: `Artify is an artist search app that helps users learn more about the musicians they love. Built with React, Artify uses the Spotify API to display the artist's name, number of followers, genres, and top songs. Unfortunately, the Spotify API doesn't include biographies, so Artify also uses the Wikipedia API to expand upon artist profiles.`,
